package cursoandroid.cibertec.com.splashscreen1;
...
public class MainSplashScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Crear mi hilo para cargar el splash
        Thread background=new Thread()
        {
            public void run(){
                //Esta parte del codigo se ejecutará dentro del hilo secundario.
                //Por ejemplo se har{ia la llamada al Servicio Web , se consumiría una BD...
